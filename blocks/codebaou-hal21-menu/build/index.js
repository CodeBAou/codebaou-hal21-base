...
const Edit = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    // Fetch site URL
    fetch('/wp-json/codebaou_hal21_end_point/v1/site-url').then(res => res.json()).then(data => setSiteUrl(data.siteUrl)).catch(error => console.error('Error fetching site URL:', error));

    // Fetch menus
    fetch('/wp-json/codebaou_hal21_end_point/v1/menus').then(res => res.json()).then(data => setMenus(data)).catch(error => console.error('Error fetching menus:', error));
  ...
  const options = menus.map(item => ({
    label: item.name,
    // Usa item.name para la etiqueta en lugar de una cadena estática
    value: item.slug
  }));
  ...
  const onChangeColorTextMenu = newColor => {
    setAttributes({
      TextColorTextMenu: newColor.hex
    });
  };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Selecciona Menu para mostrar', 'codebaou-hal21-menu-select'),
    value: selectedMenu,
    options: options,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcodebaou_hal21_menu"] = self["webpackChunkcodebaou_hal21_menu"] || [];
